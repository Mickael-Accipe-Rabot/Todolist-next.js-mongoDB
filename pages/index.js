      ...
      <div className={styles.container}>
        ...
        {tasks.map((task) => (
          <div
            className={
              task.completed
                ? styles.task_container_completed
        ...
        {tasks.length === 0 && <h2 className={styles.no_tasks}>Aucune tache en cours</h2>}
      </div>
    </main>
  );
}
